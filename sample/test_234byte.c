...
//         mpicc -o test_234byte test_234byte.c -lm lib234comp.a -ljpeg
...
int main( int argc, char* argv[] )
{
    ...
    rgba_image = (BYTE *)allocate_byte_memory_region( image_size * RGBA ); 
    assert(rgba_image); 
	...
	image_filename = strcat ( image_filename, ".rgba32\0" );
	...
	if ( fread( rgba_image, sizeof(BYTE), image_size * RGBA, in_fp ) != image_size * RGBA ) 
	{
