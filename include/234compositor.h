...
#define ALPHA_BtoF  0	// Alpha-blend Back-to-Front
#define ALPHA_A_FtoB  1	// Alpha-blend Front-to-Back
#define DEPTH_Z       2	// Z-depth Sorting
#define ALPHA_AZ_BtoF 3	// Z-depth assisted Alpha-blend 
#define ALPHA_AZ_FtoB 4	// Z-depth assisted Alpha-blend 
